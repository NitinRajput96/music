             ...
             <div className='h-full flex justify-center items-center '>
                     <div className=' w-full h-5/6 px-2 bg-black flex justify-start items-center gap-3'>
                             ...
                             <span className=' h-5/6 px-2  flex justify-center items-center flex-col max-[640px]:hidden'>
                               <span className=' font-bold text-white text-sm'>{mpsong.title}</span>
                               <span className=' w-full text-left font-semibold text-gray-400 text-xs' >{mpsong.Singer}</span>
                             </span>
             ...
             <div className='h-full  bg-black  col-span-2 max-[639px]:col-span-10 max-[640px]:col-span-9'>
                   <div className=' w-full h-3/5 pt-2 bg-black flex justify-center items-center gap-5'>
                       ...
                       <span className='   text-gray-300 flex justify-center items-center text-xl'><IoPlaySkipBackSharp/></span>
                       {
                         ...
                         <>
                          {
                            state===false?<span className=' w-8 h-8 border rounded-full bg-white  flex justify-center items-center text-2xl' onClick={()=>{pouseaudio(setState(true))}}><MdOutlinePause/></span>
                        :<span className=' w-8 h-8 border rounded-full bg-white pl-[2px] flex justify-center items-center text-xl' onClick={()=>{runsong(setState(false))}}><IoMdPlay/></span>
